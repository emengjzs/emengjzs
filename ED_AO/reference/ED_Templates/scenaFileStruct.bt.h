...
#endif
#endif
} ScenaCharacterInf1 <read=readScenaCharacterInf1>;
...
typedef struct
{
	...
	{
		ScenaCharacterInf1	scenaCharacterInf1;
	}
} ScenaCharacterInf1Group;

typedef struct	// 每个0x2BC
{
...
typedef struct
{
	...
	for (i = 0; i < scenaCharacterAmount; i++)
	{
		ScenaCharacterInf2	scenaCharacterInf2;
	}
