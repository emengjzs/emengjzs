...
(function load() {
    var ins = "${user.institute}";

    var data_source = 
        {   
            url: 'summary/lessons?institute=' + ins,
            datatype: "json",
            datafields: [
    ...
    var table_columns = [
       ...
       { text: '学期', dataField: 'term', sortable: 'true', filterable: 'true', align: 'center', cellsalign: 'center', editable: 'false',hidden: 'true', hideable:'true'},
    ...
    $('#lessons-summary-in').jqxGrid('addgroup', 'term');
